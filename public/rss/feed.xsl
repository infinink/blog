  ...
  <xsl:template match="/">
    ...
    <html class="dark scroll-smooth">
      <head>
        ...
        <style>
          :root {
            --background: hsl(40, 5%, 6%);
            --foreground: hsl(42, 25%, 90%);
            --card: hsl(40, 5%, 10%);
            --card-foreground: hsl(42, 25%, 90%);
            --primary: hsl(21, 88%, 58%);
            --primary-foreground: hsl(40, 5%, 6%);
            --accent: hsl(21, 88%, 58%);
            --accent-foreground: hsl(40, 5%, 6%);
            --border: hsl(36, 5%, 20%);
            --muted-foreground: hsl(40, 8%, 55%);
          }
          *,:after,:before {
          ...
          *,:after,:before {
          ...
          :root {
            ...
            --ui-border-color: #1f1f31;
            --btn-border: #1f1f31;
            --badge-border: var(--btn-border);
            --input-border: var(--ui-border-color);
            --ui-disabled-border: #121220;
            --ui-error-border: #e11d48;
            --ui-success-border: #65a30d;
            --input-outline: #4f46e5;
            --ui-bg: rgb(18 18 32/var(--ui-bg-opacity));
            --ui-soft-bg: #1f1f31;
            --overlay-bg: rgba(2,2,13,.25);
            --input-bg: var(--ui-soft-bg);
            --ui-disabled-bg: #121220;
            --card-padding: 1.5rem;
            --display-text-color: #fff;
            --title-text-color: var(--display-text-color);
            --body-text-color: #d6d6e1;
            --caption-text-color: #6e6e81;
            --placeholder-text-color: #4d4d5f;
            --ui-bg-opacity: 1;
          ...
          *,.border {
          ...
          a:focus-visible:focus-visible,button:focus-visible:focus-visible {
            outline-style: solid;
          }
          ...
          [data-shade=glassy] {
            --ui-bd-blur: 40px;
            --ui-bg-opacity: 0.75;
            --ui-bg: rgb(58 58 75/var(--ui-bg-opacity));
            --ui-border-color: rgba(250,250,254,.1);
            --ui-soft-bg: rgba(77,77,95,.5);
          }
          [data-shade="800"] {
            --ui-border-color: #3a3a4b;
            --ui-bg: #1f1f31;
            --ui-soft-bg: #121220;
          }
          [data-shade="900"] {
          ...
          .icon-[tabler--rss] {
            ...
            mask-size: 100% 100%;
            --svg: url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='24' height='24'%3E%3Cpath fill='none' stroke='%23fff' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' d='M4 19a1 1 0 1 0 2 0 1 1 0 1 0-2 0M4 4a16 16 0 0 1 16 16M4 11a9 9 0 0 1 9 9'/%3E%3C/svg%3E");
          }
          .link {
            --tw-text-opacity: 1;
          ...
          .link.variant-ghost:hover,.link.variant-underlined {
            text-decoration-line: underline;
          }
          .link.variant-animated {
            position: relative;
          }
          .link.variant-animated:before {
            position: absolute;
            left: 0;
            right: 0;
            bottom: 0;
          ...
          .link.variant-animated:hover:before {
          ...
          .link.variant-animated.intent-neutral:before {
            content: var(--tw-content);
            background-color: hsla(0,0%,100%,.5);
          }
          .link.variant-animated.intent-info:before {
            content: var(--tw-content);
            --tw-bg-opacity: 1;
            background-color: rgb(37 99 235/var(--tw-bg-opacity,1));
          }
          .link.variant-animated.intent-primary:before {
            content: var(--tw-content);
            --tw-bg-opacity: 1;
            background-color: rgb(79 70 229/var(--tw-bg-opacity,1));
          }
          .link.variant-ghost.intent-neutral,.link.variant-underlined.intent-neutral {
          ...
          .bg-gray-925 {
            --tw-bg-opacity: 1;
            background-color: rgb(9 9 21/var(--tw-bg-opacity,1));
          }
          .bg-gradient-to-r {
          ...
          .dark {
            ...
            --body-text-color: #d6d6e1;
            --placeholder-text-color: #4d4d5f;
            --ui-border-color: #232323;
          }
          [data-shade="900"]:where(.dark,.dark *),[data-shade="925"]:where(.dark,.dark *),[data-shade="950"]:where(.dark,.dark *) {
            --ui-border-color: #383838;
          }
          @media (min-width:640px) {
            .sm\:gap-1 {
              gap: .25rem;
          ...
          @media (min-width:1024px) {
            .lg\:dark\:bg-gray-900:is(.dark *) {
              --tw-bg-opacity: 1;
              background-color: rgb(18 18 32/var(--tw-bg-opacity,1));
            }
          }
        </style>
      </head>
        ...
        <main class="min-w-screen container mx-auto flex min-h-screen max-w-screen-lg flex-col px-4 py-6 md:px-6">
          <header class="space-y-2 pt-2 md:pt-6">
            ...
            <p class="text-body text-sm hidden" id="subscribe-links">
              ...
              <a class="link intent-neutral variant-animated font-bold" title="Feedly" data-href="https://feedly.com/i/subscription/feed/" target="_blank" rel="noopener noreferrer">
                Feedly
              </a>,
              <a class="link intent-neutral variant-animated font-bold" title="Inoreader" data-href="https://www.inoreader.com/feed/" target="_blank" rel="noopener noreferrer">
                Inoreader
              </a>,
              <a class="link intent-neutral variant-animated font-bold" title="Newsblur" data-href="https://www.newsblur.com/?url=" target="_blank" rel="noopener noreferrer">
                Newsblur
              </a>,
              <a class="link intent-neutral variant-animated font-bold" title="Follow" data-href="follow://add?url=" rel="noopener noreferrer">
                Follow
              </a>,
              <a class="link intent-neutral variant-animated font-bold" title="RSS Reader" data-href="feed:" data-raw="true" rel="noopener noreferrer">
                RSS Reader
              </a>
              or
              <a class="link intent-neutral variant-animated font-bold" title="{$title} 's feed source" data-href="" data-raw="true" rel="noopener noreferrer">
                View Source
              </a>.
            </p>
            <script>
            ...
            <div class="flex flex-col justify-between space-y-4 md:flex-row md:space-y-0">
              <div class="space-y-4">
                <a class="flex text-2xl font-bold" href="/" title="infinInk">
                  ...
                  <span class="text-title">Serene</span>
                  <span class="from-primary-600 to-accent-400 bg-gradient-to-r bg-clip-text text-transparent">
                    Ink
                  </span>
                </a>
                <div class="text-caption">
                  A quiet corner on systems, craft, and the details that make software age well.
                </div>
              </div>
              <div class="space-y-4">
                <div class="flex flex-wrap gap-x-4 gap-y-2">
                  <a class="link intent-neutral variant-animated" target="_blank" title="GitHub" href="https://github.com">
                    GitHub
                  </a>
                  <a class="link intent-neutral variant-animated" target="_blank" title="About" href="/about">
                    About
                  </a>
                </div>
